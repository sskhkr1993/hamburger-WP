...
<main class="l-main u-padding">
  ...
  <section class="information">
    ...
    <div class="information__image-outer">
      <img class="information__image Image" src="<?php echo esc_url(get_template_directory_uri()); ?>/image/single/cooked-foods-750073.jpg" alt="ハンバーガーとポテトの写真">
    </div>
  </section>
  ...
  <div class="image__outer--single">
    <img class="image__inner--single Image" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/image\single\cooked-foods-750073.jpg" alt="ハンバーガーとポテトの写真">
  </div>
